...
namespace DAERPLibrary.Migrations
{
    ...
    [Migration("20220107073633_InitialMigrationInSeparateProject")]
    partial class InitialMigrationInSeparateProject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductColorDesignModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductDivisionModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductKindModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductMaterialModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductStrapModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductDivisionModel", b =>
                {
                    b.HasOne("DAERPLibrary.Models.Product.ProductKindModel", "ProductKind")
                        .WithMany()
                        .HasForeignKey("ProductKindId");

                    b.HasOne("DAERPLibrary.Models.Product.ProductMaterialModel", "ProductMaterial")
                        .WithMany()
            ...
            modelBuilder.Entity("DAERPLibrary.Models.Product.ProductModel", b =>
                {
                    b.HasOne("DAERPLibrary.Models.Product.ProductColorDesignModel", "ProductColorDesign")
                        .WithMany()
                        .HasForeignKey("ProductColorDesignId");

                    b.HasOne("DAERPLibrary.Models.Product.ProductDivisionModel", "ProductDivision")
                        .WithMany()
                        .HasForeignKey("ProductDivisionId");

                    b.HasOne("DAERPLibrary.Models.Product.ProductStrapModel", "ProductStrap")
                        .WithMany()
